...
public class SoundManager : MonoBehaviour
{
    ...
    {
        Queue(clips, delayBetween);
    }

    public static void Queue(AudioClip[] clips, float delay, int channel = 1)
    {
        Instance.StartCoroutine(PlayQueue(clips, delay, channel));
    }
    ...
    private static IEnumerator PlayQueue(AudioClip[] clips, float delayBetween, int channel)
    {
